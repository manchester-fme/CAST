...
STORAGE_PROVIDER environment variable. See src/storage_backend.py for details.
"""
...
class S3StateManager:
    def __init__(self, bucket: str, solver: str, region: Optional[str] = None):
        ...
        try:
            ...
            raise S3StateError("Credentials not found. Set the ACCESS_KEY_ID / SECRET_ACCESS_KEY secrets "
                                "and run src/configure_storage.sh first.")
